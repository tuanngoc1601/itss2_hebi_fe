...
const TypeDropdownFilter = (props) => {
    ...
    const types = [ {value:"all", display:"Tất cả hình thức"},
    ...
    return (
        <div className="block">
            ...
            >
                ...
                {
                props.type === "all" ? types[0].display :
                props.type === "fulltime" ? types[1].display :
                props.type === "parttime" ? types[2].display : types[0].display
            }
                    </span>
